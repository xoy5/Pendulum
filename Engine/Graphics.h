...
public:
	...
	template<typename T>
	void PutPixel( Vec2_<T> vec, Color c );
	void PutPixel( int x,int y,Color c );
	//Rect
	RectI GetRect() const;
	void DrawRect( int x, int y, int size, Color c);
	void DrawRect( RectI rect, Color c);
	void DrawRectByCenter( int x, int y, int width, int height, Color c);
	void DrawRect( int x, int y, int width, int height, Color c);
	// Others
	void DrawLine(Vec2 pos1, Vec2 pos2, Color c, int rope, int width = 0);
